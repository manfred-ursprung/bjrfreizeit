...
$TCA['tx_bjrlend_domain_model_target_group'] = array(
	'ctrl' => $TCA['tx_bjrlend_domain_model_target_group']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:bjr_lend/Resources/Private/Language/locallang_db.xlf:tx_bjrlend_domain_model_target_group.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
