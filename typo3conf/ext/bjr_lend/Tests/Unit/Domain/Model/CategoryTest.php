...
/**
 * Test case for class \Bjr\BjrLend\Domain\Model\Category.
 *
 * @version $Id$
...
class CategoryTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	public function setUp() {
		$this->fixture = new \Bjr\BjrLend\Domain\Model\Category();
	}
	 ...
	 * @test
	 */
	public function getChildsReturnsInitialValueForCategory() { 
		$newObjectStorage = new \TYPO3\CMS\Extbase\Persistence\Generic\ObjectStorage();
		$this->assertEquals(
			$newObjectStorage,
			$this->fixture->getChilds()
		);
	}
	...
	public function setChildsForObjectStorageContainingCategorySetsChilds() { 
		...
		$this->assertSame(
			$objectStorageHoldingExactlyOneChilds,
			$this->fixture->getChilds()
		);
	}
	 ...
	 * @test
	 */
	public function addChildToObjectStorageHoldingChilds() {
		$child = new \Bjr\BjrLend\Domain\Model\Category();
